							...
							<div key={title} className="group card-surface flex flex-col justify-between">
								<div className="flex flex-col gap-2">
									<div className="flex items-center gap-2">
										<div className="flex size-12 shrink-0 items-center justify-center rounded-xl bg-(--bg-secondary) shadow-(--shadow)">
											<Icon className="size-6 text-(--accent-secondary) transition-transform duration-500 group-hover:scale-125" />
										</div>
